...
const Links = () => {
    ...
    return (
        <>
            <Link prefetch={true} style={{visibility: pathname === "/yesterday" ? "hidden" : "visible"}} href="/yesterday" className={styles.link}>
                <ChevronLeft />
                LUN
            </Link>
