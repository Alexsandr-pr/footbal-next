...
const Links = () => {
    ...
    return (
        <>
            <Link  style={{visibility: pathname === "/yesterday" ? "hidden" : "visible"}} href="/yesterday" className={styles.link}>
                <ChevronLeft />
                LUN
            </Link>
            ...
            <Link  style={{visibility: pathname === "/tomorrow" ? "hidden" : "visible"}} href="/tomorrow" className={styles.link}>
                MIE
                <ChevronRight/>
            </Link>
        </>
