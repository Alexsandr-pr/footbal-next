...
const Links = () => {
    ...
    return (
        <>
            <a   style={{visibility: pathname === "/yesterday" ? "hidden" : "visible"}} href="/yesterday" className={styles.link}>
                <ChevronLeft />
                LUN
            </a>
            ...
            <a  style={{visibility: pathname === "/tomorrow" ? "hidden" : "visible"}} href="/tomorrow" className={styles.link}>
                MIE
                <ChevronRight/>
            </a>
        </>
