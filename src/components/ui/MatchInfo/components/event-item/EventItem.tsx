...
import { EventItemProps } from '@/lib/types/props/match';
    ...
    return (
        <Link prefetch={false} href={`/game/${game.id}`} className={styles.item}>
            <div ref={block} className={styles.body}>
                <EventTime gameTimeStatusToDisplay={gameTimeStatusToDisplay} tv_networks={game?.tv_networks} gameTimeToDisplay={game_time_to_display} startTime={start_time} status={status} />
